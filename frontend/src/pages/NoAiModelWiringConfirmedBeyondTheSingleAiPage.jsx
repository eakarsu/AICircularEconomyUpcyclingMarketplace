...
export default function NoAiModelWiringConfirmedBeyondTheSingleAiPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-no-ai-model-wiring-confirmed-beyond-the-single-ai-/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>No AI model wiring confirmed beyond the single ai.js route</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/gap-no-ai-model-wiring-confirmed-beyond-the-single-ai-/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
